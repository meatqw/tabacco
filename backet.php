...
<body class="page__body">
  ...
  <div class="ordering__container container">
    ...
    <div class="ordering__content">
      <div class="ordering__item ordering-item">
        <div class="ordering-item__head">
          <h2 class="ordering-item__title">Табак для кальяна</h2>
        ...
        <div class="ordering-item__body">
          <div class="product ordering-item__product">
    ...
    <div class="ordering__footer ordering-footer">
      <div class="header__right ordering-footer__item">
        ...
        <div class="ordering__total">Всего: 29 200 ₽</div>
      </div>
      <div class="ordering-footer__item">
        <button class="btn-reset ordering-footer__btn ordering-footer__btn--clear">Очистить корзину</button>
        <button class="btn-reset btn ordering-footer__btn">Далее</button>
      </div>
    </div>
  </div>
</section>
