    ...
    <main class="main">
      <section class="login">
        <div class="login__container container">
          <h1 class="title visually-hidden">Tobaco Authorization</h1>
          <div class=" login__logo">
            <img loading="lazy" src="./img/tobacco.svg" class="image" width="295" height="42" alt="Tobacco">
          </div>
          <form action="#" class="form login__form">
            <label class="form__label label login__label">
              <input type="email" name="email" class="input-reset form__input input login__input"
                placeholder="Электронный адрес">
            </label>
            <label class="form__label label login__label password">
